...
if __name__ == '__main__':
    ...
    for point,run in zip(opts_unscaled,runs):
        ...
        if auto_limits != "determine":
            fig_infections.savefig('data_vis/%i_PDF_%s.png' %(run , 'infections'), 
                                    format='png', dpi=100,bbox_inches='tight')
            fig_fatalities.savefig('data_vis/%i_PDF_%s.png' %(run , 'fatalities'), 
                                format='png', dpi=100,bbox_inches='tight')
            fig_dist.savefig('data_vis/%i_PDF_%s.png' %(run , 'distance'), 
                            format='png', dpi=100,bbox_inches='tight')
            fig_GC.savefig('data_vis/%i_PDF_%s.png' %(run , 'ground_covered'), 
                            format='png', dpi=100,bbox_inches='tight')
    ...
    if same_axis:
        fig_infections.savefig('data_vis/PDF_%s.png' %('infections'), 
                                format='png', dpi=100,bbox_inches='tight')
        fig_fatalities.savefig('data_vis/PDF_%s.png' %('fatalities'), 
                            format='png', dpi=100,bbox_inches='tight')
        fig_dist.savefig('data_vis/PDF_%s.png' %('distance'), 
                        format='png', dpi=100,bbox_inches='tight')
        fig_GC.savefig('data_vis/PDF_%s.png' %('ground_covered'), 
                       format='png', dpi=100,bbox_inches='tight')
        plt.show()